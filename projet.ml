...
dag5 2 : [[("d", 171); ("t", 151)]; [("f", 91); ("b", 171)]; [("a", 42); ("j", 81)];
 [("i", 42); ("g", 101)]; [("e", 111); ("c", 131)]; [("h", 11); ("l", 51)]]

dag5 7 : [[("b", 171); ("d", 171); ("t", 151)]; [("a", 42); ("f", 91); ("j", 81)];
 [("c", 131); ("e", 111); ("i", 42); ("g", 101)]; [("h", 11); ("l", 51)]]

dag3 3 : [[("j", 1); ("n", 1); ("k", 1)]; [("m", 1); ("g", 1); ("d", 1)];
 [("l", 1); ("f", 1); ("a", 1)]; [("v", 1); ("c", 1); ("e", 1)];
 [("i", 1); ("h", 1)]]
 
dag3 1 : [[("k", 1)]; [("n", 1)]; [("j", 1)]; [("g", 1)]; [("d", 1)]; [("l", 1)];
 [("m", 1)]; [("f", 1)]; [("a", 1)]; [("e", 1)]; [("c", 1)]; [("v", 1)];
 [("h", 1)]; [("i", 1)]]
